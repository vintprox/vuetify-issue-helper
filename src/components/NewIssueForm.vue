  ...
  <v-card>
    ...
    >
      <v-container class="mt-3">
        <v-row>
          ...
          <v-col cols="12">
            ...
            />
            <similar-issues
              v-if="newIssue.repository && newIssue.repository.value === 'vuetify'"
        ...
        <v-slide-y-transition mode="out-in">
          <v-row v-if="newIssue.type === 'bug'">
            ...
            <v-col
              v-if="newIssue.repository.value === 'vuetify'"
              cols="12"
            >
              <v-checkbox
      ...
      <v-snackbar
        ...
        color="error"
      >
        <span>API request failed. Please report this on <a
